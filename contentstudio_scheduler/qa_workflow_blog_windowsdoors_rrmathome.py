#!/usr/bin/env python3
"""
Blog QA Checker — RRM@home Workspace (Windows & Doors)
Runs 3-phase QA on Windows & Doors blog posts scheduled for a given Monday.

Usage:
    python qa_workflow_blog_windowsdoors_rrmathome.py 2026-05-18
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage:   python qa_workflow_blog_windowsdoors_rrmathome.py <date>")
        print("Example: python qa_workflow_blog_windowsdoors_rrmathome.py 2026-05-18")
        sys.exit(1)
    ...
    print("=" * 60)
    print(f"  Blog QA — RRM@home (Windows & Doors)")
